...
privKeyNumEachPeer=(10) # Using as buffer for lagged instance. When chage this, please also modify param in rpcs.generateBLSKeys()
UseSig=(false)
...
throughputsAuthSinglePbft[4]="256"
throughputsAuthSinglePbft[8]="256"
...
throughputsNoAuthSinglePbft[4]="256"
throughputsNoAuthSinglePbft[8]="256"
